...
export function AppSidebar({
	...
	// Resolve active organization & user mode (Personal vs Organization)
	const activeOrg =
		currentOrg ||
	...
	const isOrgMode =
		authUser?.accountType === "ORGANIZATION" || Boolean(activeOrg);
	...
	return (
		<Sidebar collapsible="icon">
			{/* Header — Brand Logo & Active Wor.envkspace Badge */}
			<SidebarHeader>
				<SidebarMenu>
					<SidebarMenuItem>
						<SidebarMenuButton
